...
var wc_add_to_cart_params = {
    ajax_url: "/novo/dark/wp-admin/admin-ajax.php",
    wc_ajax_url: "/novo/dark/?wc-ajax=%%endpoint%%",
    i18n_view_cart: "View cart",
    cart_url: "https://promo-theme.com/novo/dark/cart/",
    is_cart: "",
...
jQuery(function (e) {
    ...
    t.prototype.onAddToCart = function (t) {
        ...
        var a = e(this), o = a.closest(".woocommerce-mini-cart-item");
        t.preventDefault(), o.block({
            message: null,
            overlayCSS: {opacity: .6}
        }), e.post(wc_add_to_cart_params.wc_ajax_url.toString().replace("%%endpoint%%", "remove_from_cart"), {cart_item_key: a.data("cart_item_key")}, function (t) {
        ...
        a && (e.each(a, function (t) {
            e(t).addClass("updating").fadeTo("400", "0.6").block({message: null, overlayCSS: {opacity: .6}})
...
jQuery(function (jQuery) {
    jQuery(".zilla-likes").on("click", function () {
        ...
        var id = jQuery(this).attr("id"), postfix = link.attr("data-postfix");
        jQuery.ajax({
            type: "POST",
            url: zilla_likes.ajaxurl,
            data: {action: "zilla-likes", likes_id: id, postfix: postfix},
    ...
    if (jQuery("body.ajax-zilla-likes").length) {
        jQuery(".zilla-likes").each(function () {
            ...
            jQuery(this).load(zilla_likes.ajaxurl, {action: "zilla-likes", post_id: id})
        })
    }
});
...
var wpcf7 = {
    apiSettings: {
        root: "https://promo-theme.com/novo/dark/wp-json/contact-form-7/v1",
...
jQuery(function (i) {
    i(".woocommerce-ordering").on("change", "select.orderby", function () {
        ...
        Cookies.set("store_notice", "hidden", {path: "/"}), i(".woocommerce-store-notice").hide()
        ...
        var o = i(this).parent(), e = o.find("span.description");
        ...
        o.length && i("html, body").animate({scrollTop: o.offset().top - 100}, 1e3)
    }
});
var wc_cart_fragments_params = {
    ajax_url: "/novo/dark/wp-admin/admin-ajax.php",
    wc_ajax_url: "/novo/dark/?wc-ajax=%%endpoint%%",
    cart_hash_key: "wc_cart_hash_2bf66c985087328e3793d5b5b7994ba7",
    fragment_name: "wc_fragments_2bf66c985087328e3793d5b5b7994ba7"
};
